        ...
        for idx in tqdm(keys, desc=f"Process {mp.current_process().pid}"):
            ...
            for j, response in enumerate(responses):
                try:
                    ...
                    # Store results for this specific response
                    if idx not in results_for_image:
                        results_for_image[idx] = []
                    results_for_image[idx].append(response)
            ...
            # Save results for this image_id
            save_results_image_wise(results_for_image, output_dir, image_id)
