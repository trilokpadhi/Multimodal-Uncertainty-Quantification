...
# tuples = ['tables', 'plates', ('tables', 'state', 'no'), ('plates', 'state', 'no'), ('tables', 'in the picture', 'plates')]
# labels = ['tables', 'plates', 'no tables', 'no plates']
labels = ['There are no tables or plates in the picture.', 'There is a table in the picture.', 'There is a table but no plate in the picture.']
# labels = [f'{t[0]} {t[1]} {t[2]}' for t in tuples]
# labels = []

# for t in tuples:
#     if isinstance(t, tuple) and len(t) == 3:
#         labels.append(f'{t[0]} {t[1]} {t[2]}')  # For 3-element tuples
#     else:
#         labels.append(str(t))  # For non-tuple or non-3-element cases
...
# # labels = " ".join([f'{t[0]} {t[1]} {t[2]} .' for t in tuples])
# labels = [f'{t[0]} {t[1]} {t[2]}' for t in tuples]
# print(labels)
...
# print('Checking batch inference')
