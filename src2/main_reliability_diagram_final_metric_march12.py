...
if __name__ == '__main__':
    ...
    exponent_C_candidates = np.linspace(0, 0.3, 51)  # e.g. 51 steps in [0,1]
    ...
    for cv_iter in range(no_of_cv_iterations):
        ...
        for conf_col in confidence_cols:
            ...
            for gr_col in gr_cols:
                ...
                print(f"  Best T={best_T_exp:.3f}, C={best_C_exp:.3f} (calib ECE={best_ece_exp:.4f})")
...
# ###########################################
# ########### End of main script, hence scratch functions which arent used anymore, saving it here for future purposes ############
# ###########################################
